"""TH attack strategies and their runtime context."""
...
def load_attack_config():
    """Load TH calibration data from attack_th.json."""
...
def save_attack_config():
    """Save TH calibration data to attack_th.json."""
    config = {}
...
def build_edge_zone_points():
    """Build deployment points between the calibrated EDGE endpoints."""
...
def get_th_slot_position(n):
    """Return the estimated screen position for TH troop slot n."""
...
def select_two_points(title, prompt):
    """Show a screenshot and let the user select two calibration points."""
...
def select_edge_zone():
    """Calibrate and save the TH deployment EDGE zone."""
...
def select_slot_centers():
    """Calibrate and save TH troop slot 1 and slot 2 centers."""
    global TH_SLOT_1_CENTER, TH_SLOT_2_CENTER
